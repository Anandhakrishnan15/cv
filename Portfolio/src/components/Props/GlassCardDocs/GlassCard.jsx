...
const GlassCard = ({
  ...
  const shadow = useMotionValue("0px 20px 40px rgba(0,0,0,0.3)");

  // 🖱️ 3D effect on mouse
  ...
  return (
    <>
      <motion.div
        ref={cardRef}
        className={`relative z-10 backdrop-blur-md ${cardBg} border ${borderColor} rounded-2xl p-8 max-w-md w-full`}
        style={{
          rotateX,
          rotateY,
          transformStyle: "preserve-3d",
          boxShadow: shadow, // 🎯 Apply motion-based shadow
        }}
...
// <GlassCard
//   title="🔒 Secure & Smooth"
//   description="Tilt-friendly card with dark theme."
//   buttonText="Explore"
//   textColor="text-white"
//   headingColor="text-3xl font-semibold"
